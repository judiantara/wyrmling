{
  ...
  let
    ...
    fern         = systemModules ++ [ ./modules/fern         ];
    hookfang     = systemModules ++ [ ./modules/hookfang     ];
    meatlug      = systemModules ++ [ ./modules/meatlug      ];
    rumbletail   = systemModules ++ [ ./modules/rumbletail   ];
    skullcrusher = systemModules ++ [ ./modules/skullcrusher ];
    stormfly     = systemModules ++ [ ./modules/stormfly     ];
    talonwhip    = systemModules ++ [ ./modules/talonwhip    ];
    tigress      = systemModules ++ [ ./modules/tigress      ];
  ...
  in {
    ...
    templates = {
      ...
      hookfang = {
        path = ./machines/hookfang;
        description = "Hookfang NixOS Machine Configuration";
      };
      meatlug = {
      ...
      rumbletail = {
        path = ./machines/rumbletail;
        description = "RumbleTail NixOS Machine Configuration";
      };
      shadowfax = {
      ...
      talonwhip = {
        path = ./machines/talonwhip;
        description = "TalonWhip NixOS Machine Configuration";
      };
      tigress = {
        path = ./machines/tigress;
        description = "Tigress NixOS Machine Configuration";
      };
      toothless = {
