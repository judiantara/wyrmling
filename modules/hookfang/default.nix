...
#    ../../config/console-disabled.nix
    ...
    ../workhorses
    ./networking.nix
    (import ../../config/disk-partition.nix { name = "${deviceName}"; device =  "/dev/disk/by-id/ata-KYO_1TB_2025030400012522"; })
    (import ../../config/disk-swap.nix      { name = "${deviceName}"; size   =  "48G"; })
