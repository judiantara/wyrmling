...

{
  boot.initrd = {
    ...
    luks = {
      ...
      devices."meatlug" = {
        device = "/dev/disk/by-partlabel/Shenlong"; # Be sure to update this to the correct volume
        ...
        yubikey = {
          ...
          storage = {
            device = "/dev/disk/by-partlabel/ShenlongESP"; # Be sure to update this to the correct volume
            fsType = "vfat";
            path = "/salt.conf";
          };
        };
