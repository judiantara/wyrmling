...

{
  ...
  in [
    ...
    ../../users/judiantara
    (import ../../config/disk-partition.nix { name = "${deviceName}"; device =  "/dev/disk/by-id/ata-INTEL_SSDSCKKF128G8L_BTLA75000T93128I"; })
    (import ../../config/disk-swap.nix      { name = "${deviceName}"; size   =  "8G"; })
